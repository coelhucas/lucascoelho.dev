...
var postsPath = process.env.NETLIFY ? import_path.default.join(__dirname, "../../../..", "posts") : import_path.default.join(process.cwd(), "posts");
